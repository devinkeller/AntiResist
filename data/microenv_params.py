...
class MicroenvTab(object):
    ...
    def __init__(self):
        ...
        self.antibiotic_decay_rate = FloatText(value=0.0001,
        ...
        self.antibiotic_initial_condition = FloatText(value=0.2,style=style, layout=widget_layout)
        ...
        self.mutantFactor_diffusion_coefficient = FloatText(value=50.0,
